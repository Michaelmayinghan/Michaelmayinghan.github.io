...
The knowledge base contains 22 semantic chunks in both Chinese and English, covering profile, education, engineering projects, skills, and photography practice. Each query uses TF-IDF (term frequency–inverse document frequency) with length normalisation; chunks matching the query language get a 10% boost.
